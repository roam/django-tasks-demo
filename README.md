...
Second: this project assumes you've got a [ntfy.sh](https://ntfy.sh) account and a topic URL set in your environment:
...
For more details on this, check out the article on [Roam*notes]().
